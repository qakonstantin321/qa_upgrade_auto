...
RECEIVER_USER_KEY = "user_2"
ACCOUNT_USER_2_KEY = "account_user_2"
TRANSFER_RESPONSE_KEY = "transfer_response"
...
class TestTransferMoney:
    ...
    def test_transfer_money_different_users(self, api_manager: ApiManager,
        ...
        request.node.user_properties[RECEIVER_USER_KEY] = user_2
        request.node.user_properties[ACCOUNT_USER_2_KEY] = account_user_2
    ...
    def test_transfer_money_accounts_same_user(self, api_manager: ApiManager,
                                               ...
                                               deposit_account: DepositMoneyResponse,
                                               request: pytest.FixtureRequest):
        account_user_2 = api_manager.user_steps.create_user_account(user_request)
        request.node.user_properties[ACCOUNT_USER_2_KEY] = account_user_2
